...
headers = {
    ...
    'cookie': 'mid=XWuPPAALAAFm8UzOx34fg8ZyzKAS; csrftoken=qv8sb6fihprCL9aRZMdP8mlS78UpwaQI; ds_user_id=1547221429; sessionid=1547221429%3ANNlLNIV46letsC%3A21; shbid=6505; shbts=1568549610.5882828; rur=FRC; urlgen="{\"47.52.61.244\": 45102}:1i9hHl:MbXrF3HMElteR4KaV-O15JbJYjQ"'
}
...
def main(user):
    ...
    html = get_html(url)
    urls = get_urls(html)
    dirpath = r'F:/Instagram/{0}'.format(user)
    ...
    for i in range(len(urls)):
        ...
        try:
            ...
            file_path = r'F:/Instagram/{0}\{1}.{2}'.format(user, md5(content).hexdigest(), endw)
